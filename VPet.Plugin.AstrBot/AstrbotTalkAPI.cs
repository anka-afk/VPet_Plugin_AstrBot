...
{
    public class AstrbotTalkAPI : TalkBox
    {
        public AstrbotTalkAPI(AstrbotPlugin mainPlugin) : base(mainPlugin)
        {
            Plugin = mainPlugin;
        }
        protected AstrbotPlugin Plugin;
        public override string APIName => "Astrbot";
